...
import cn.yangcode.hrm.query.TenantQuery;
...
public class TenantController {
    ...
    */
    ...
    public PageList<Tenant> json(@RequestBody TenantQuery query)
    {
        ...
        EntityWrapper<Tenant> tenantEntityWrapper = new EntityWrapper<>();
        tenantEntityWrapper.like("companyName", query.getKeyword());
        page = tenantService.selectPage(page,tenantEntityWrapper);
